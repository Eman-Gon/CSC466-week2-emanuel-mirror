...
print("="*60)
print("SIMILARITY-BASED EVALUATION")
print("="*60)
print("Credit for recommending items SIMILAR to what user liked")
print("="*60)
...
# Build item similarity matrix based on co-viewing
...
WATCH_THRESHOLD = 0.5
SIMILARITY_THRESHOLD = 0.3  # Items with >30% similarity count as "similar enough"

def evaluate_with_similarity(rec_file, method_name):
    """
    Award credit if recommendation is:
    1. Exact match to liked item (full credit = 1.0)
    2. Similar to liked items (partial credit = similarity score)
    """
    ...
    for _, row in recs.iterrows():
        ...
        for rec in recs_list:
            if rec in liked_items:
                ...
                # Check similarity to liked items
                max_sim = 0
                ...
                # Award partial credit for similar items
...
for method, exact_p, sim_p in results:
    ...
    print(f"{method:<30} {sim_p:.3f} (+{improvement:.1f}% from similarity)")

print("\n" + "="*60)
print("INTERPRETATION")
print("="*60)
print("Exact P@2:    Only counts if recommendation matches viewed items")
print("Similar P@2:  Also credits recommendations similar to liked items")
print("")
print("High 'Similar P@2' means the model recommends items that are")
print("similar to what users like, even if they haven't watched them yet.")
print("This is good for discovery!")
print("="*60)